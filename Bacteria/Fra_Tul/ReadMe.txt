...
with open('/tmp/guest-4njzsf/Desktop/Fra_Tul/Fra_Tul_prot.csv') as csvDataFile:   #source csv file with onl one column containing the protein sequence
...
outputCSV1 = csv.writer(open('/tmp/guest-4njzsf/Desktop/Fra_Tul/output1.csv', "w"))     #output csv file, needs to be created by user before hand
outputCSV2 = csv.writer(open('/tmp/guest-4njzsf/Desktop/Fra_Tul/output2.csv', "w"))     #output csv file, needs to be created by user before hand
outputCSV3 = csv.writer(open('/tmp/guest-4njzsf/Desktop/Fra_Tul/output3.csv', "w"))     #output csv file, needs to be created by user before hand
outputCSV4 = csv.writer(open('/tmp/guest-4njzsf/Desktop/Fra_Tul/output4.csv', "w"))     #output csv file, needs to be created by user before hand
outputCSV5 = csv.writer(open('/tmp/guest-4njzsf/Desktop/Fra_Tul/output5.csv', "w"))     #output csv file, needs to be created by user before hand
