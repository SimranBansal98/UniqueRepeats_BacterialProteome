...
with open('/home/cic/Downloads/Bur_Cep/Bur_Cep_Prot.csv') as csvDataFile:   #source csv file with onl one column containing the protein sequence
...
outputCSV1 = csv.writer(open('/home/cic/Downloads/Bur_Cep/output1.csv', "w"))     #output csv file, needs to be created by user before hand
outputCSV2 = csv.writer(open('/home/cic/Downloads/Bur_Cep/output2.csv', "w"))     #output csv file, needs to be created by user before hand
outputCSV3 = csv.writer(open('/home/cic/Downloads/Bur_Cep/output3.csv', "w"))     #output csv file, needs to be created by user before hand
outputCSV4 = csv.writer(open('/home/cic/Downloads/Bur_Cep/output4.csv', "w"))     #output csv file, needs to be created by user before hand
outputCSV5 = csv.writer(open('/home/cic/Downloads/Bur_Cep/output5.csv', "w"))     #output csv file, needs to be created by user before hand
